...
private int renouvellementsRestants; 		// le nombre de renouvellementsRestants possibles

public Prescription(String nomMedicament, double dose, int renouvellementsRestants) {
...
/**
 * @param renouvellementsRestants the renouvellementsRestants to set
 */
...
public String afficherPrescription() {
	return new String(this.nomMedicament + " " + this.dose +
			" Renouv: " + (this.renouvellementsRestants));
	}
}
